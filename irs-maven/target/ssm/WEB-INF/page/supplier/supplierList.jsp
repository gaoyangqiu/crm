...
<%--		<shiro:hasPermission name="supplier:supplier:save">--%>
			<div class="layui-inline">
				<a class="layui-btn layui-btn-normal supplierAdd_btn" ><i class="layui-icon">&#xe608;</i>   添加供应商</a>
			</div>
<%--		</shiro:hasPermission>--%>
<%--		<shiro:hasPermission name="supplier:supplier:delete">--%>
			<div class="layui-inline">
...
<%--		</shiro:hasPermission>--%>
	...
	<!-- 数据表格 -->
	<table id="supplierList" lay-filter="test"></table>
	
	<script type="text/javascript" src="${ctx}/layui/layui.js"></script>
	<script type="text/javascript" src="${ctx}/page/supplier/supplierList.js"></script>
