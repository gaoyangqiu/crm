...
<body class="childrenBody">
	<form class="layui-form" style="width: 80%;" id="aaf">
		<input type="hidden" name="number" value="${saleOrder.number }"/>
		<input type="hidden" name="salePrice" value="${saleOrder.salePrice }"/>
		<input type="hidden" name="realPrice" value="${saleOrder.realPrice }"/>
		<input type="hidden" name="supplierId" value="${saleOrder.supplierId }"/>
		<input type="hidden" name="customerId" value="${saleOrder.customerId }"/>
        <input type="hidden" name="type" value="${saleOrder.type }"/>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="amount" class="layui-input userName"
					   lay-verify="required"	   placeholder="请输入数量" value="">
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
				<button class="layui-btn" lay-submit="" lay-filter="saveReturnSaleOrder">立即提交</button>
			</div>
		</div>
	</form>
	<script type="text/javascript" src="${ctx }/layui/layui.js"></script>
	<script type="text/javascript" src="${ctx }/page/saleOrder/addreturnsaleOrder.js"></script>
</body>
</html>