...
<body class="childrenBody">
	...
	<blockquote class="layui-elem-quote list_search">
			<div class="layui-inline">
				<a class="layui-btn layui-btn-normal goodsTypeAdd_btn" ><i class="layui-icon">&#xe608;</i>   添加商品</a>
			</div>
			<div class="layui-inline">
	...
	<!-- 数据表格 -->
	<table id="goodsTypeList" lay-filter="test"></table>
	
	<script type="text/javascript" src="${ctx}/layui/layui.js"></script>
	<script type="text/javascript" src="${ctx}/page/goodstype/goodstypeList.js"></script>
